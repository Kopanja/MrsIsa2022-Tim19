...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	public void configure(WebSecurity web) {
		...
		web.ignoring().antMatchers(HttpMethod.POST, "/api/auth/**");
		web.ignoring().antMatchers(HttpMethod.GET,"/api/offer/*/promotion", "/api/offer/*","/api/offer/*/unavailable-dates", "/api/review/offer/*", "/api/city/**",  "/api/accommodation/**", "/api/fishingTour/**","/api/boat/**");
